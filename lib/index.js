...
var import_BatchedBridge4 = __toESM(require("react-native/Libraries/BatchedBridge/BatchedBridge"));
...
// src/network/index.ts
var NetworkModule = import_react_native12.NativeModules.NetworkModule;
var Network = class extends NativeInstance {
  constructor() {
    ...
    __publicField(this, "initialize", () => {
      if (!this.isInitialized) {
        import_BatchedBridge4.default.registerCallableModule(`Network-${this.nativeId}`, this);
