...
var BufferModule = import_react_native13.NativeModules.BufferModule;
...
// src/player.ts
var PlayerModule = import_react_native14.NativeModules.PlayerModule;
...
// src/offline/offlineContentManager.ts
var OfflineModule = import_react_native15.NativeModules.BitmovinOfflineModule;
  ...
  constructor(config) {
    ...
    __publicField(this, "initialize", async () => {
      ...
      if (!this.isInitialized && this.config) {
        this.eventSubscription = new import_react_native15.NativeEventEmitter(
          OfflineModule
        ).addListener(
...
var BitmovinCastManagerModule = import_react_native16.NativeModules.BitmovinCastManagerModule;
var BitmovinCastManager = {
   ...
   */
  isInitialized: async () => {
    if (import_react_native16.Platform.OS === "ios" && import_react_native16.Platform.isTV) {
      return false;
    }
