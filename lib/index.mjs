...
// src/player.ts
import { NativeModules as NativeModules9, Platform as Platform4 } from "react-native";
...
// src/player.ts
var PlayerModule = NativeModules9.PlayerModule;
...
import {
  NativeEventEmitter,
  NativeModules as NativeModules10
} from "react-native";
...
// src/offline/offlineContentManager.ts
var OfflineModule = NativeModules10.BitmovinOfflineModule;
...
import { NativeModules as NativeModules11, Platform as Platform5 } from "react-native";
var BitmovinCastManagerModule = NativeModules11.BitmovinCastManagerModule;
var BitmovinCastManager = {
   ...
   */
  isInitialized: async () => {
    if (Platform5.OS === "ios" && Platform5.isTV) {
      return false;
    }
