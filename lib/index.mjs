...
var FullscreenHandlerModule = NativeModules2.FullscreenHandlerModule;
...
var Uuid2 = NativeModules3.UuidModule;
var CustomMessageHandlerModule = NativeModules3.CustomMessageHandlerModule;
...
var Uuid3 = NativeModules4.UuidModule;
...
// src/drm/index.ts
var DrmModule = NativeModules5.DrmModule;
...
// src/player.ts
import { NativeModules as NativeModules7, Platform as Platform4 } from "react-native";

// src/source.ts
import { NativeModules as NativeModules6 } from "react-native";
var SourceModule = NativeModules6.SourceModule;
...
// src/player.ts
var PlayerModule = NativeModules7.PlayerModule;
...
import {
  NativeEventEmitter,
  NativeModules as NativeModules8,
...
// src/offline/offlineContentManager.ts
var OfflineModule = NativeModules8.BitmovinOfflineModule;
